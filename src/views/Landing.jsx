  ...
  return (
    <div className='h-screen'>
      ...
      <section className='py-8 mx-auto px-6'>
        ...
        <h4>Crea tu cuenta. Elegi cuanto invertis. Crece en <b>Dólares</b></h4>
      ...
      <section className='bg-white'>
        <div className='mb-[-0.1rem] max max-h-[10rem]'>
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 375 81" fill="none" overflow="auto">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M0 0L20.9375 1.6875C41.5625 3.375 83.4375 6.75 125 16.875C166.562 27 208.438 43.875 250 42.1875C291.562 40.5 333.438 20.25 354.062 10.125L375 0V81H354.062C333.438 81 291.562 81 250 81C208.438 81 166.562 81 125 81C83.4375 81 41.5625 81 20.9375 81H0V0Z" fill="#4886F8"/>
          </svg>
        </div>
        <div className='bg-primaryBlue py-[2rem] mx-auto px-6'>
        <h2 className='text-white text-[3rem] font-[500] leading-[1.2]'>Enterate de las <b>novedades</b></h2>
        <h6 className='text-white font-[500] text-[1.2rem]'>Sumate a nuestro <b className='underline'>blog</b> para no perderte de ningún avance de obra u oportunidad de inversión</h6>
      ...
      <section className='bg-primaryBlue pb-4'>
