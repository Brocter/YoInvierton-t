...
export const OportunidadesCard = (props) => {
  ...
  const {departamento, background, porcentaje, rendimiento, minimoInversion, inversionMax, totalInvertido} = cardData;
    return(
        <div
        className='mx-auto border mt-8 max-w-[35rem] border-primaryLightBlue rounded-b-xl rounded-tr-[1.9rem] shadow-lg shadow-primaryLightBlue w-[100%] overflow-hidden md:block'>
